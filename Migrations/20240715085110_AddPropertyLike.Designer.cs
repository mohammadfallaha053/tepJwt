...
namespace JWT53.Migrations
{
    ...
    [Migration("20240715085110_AddPropertyLike")]
    partial class AddPropertyLike
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JWT53.Models.Amenity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("JWT53.Models.MyFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JWT53.Models.Property", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsShowInAdPage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JWT53.Models.PropertyAmenity", b =>
                {
                    b.Property<Guid>("PropertyId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JWT53.Models.MyFile", b =>
                {
                    b.HasOne("JWT53.Models.Property", null)
                        .WithMany("Files")
            ...
            modelBuilder.Entity("JWT53.Models.PropertyAmenity", b =>
                {
                    b.HasOne("JWT53.Models.Amenity", "Amenity")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JWT53.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
